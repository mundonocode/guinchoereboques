  ...
  public: {
    Tables: {
      ...
      mensagens_chat: {
        ...
        Relationships: [
          {
            foreignKeyName: "mensagens_chat_corrida_id_fkey"
            columns: ["corrida_id"]
            isOneToOne: false
      ...
      pagamentos: {
        ...
        Relationships: [
          {
            foreignKeyName: "pagamentos_solicitacao_id_fkey"
            columns: ["solicitacao_id"]
            isOneToOne: true
            referencedRelation: "solicitacoes"
            referencedColumns: ["id"]
      ...
      veiculos_guincho: {
        ...
        Relationships: [
          {
            foreignKeyName: "veiculos_guincho_perfil_id_fkey"
            columns: ["perfil_id"]
            isOneToOne: true
            referencedRelation: "perfis"
            referencedColumns: ["id"]
